...
from mod.dataobjects.configuration.domain_fixed_parameter import DomainFixedParameter
...
class ExecutionParameters():
    ...
    def __init__(self):
        ...
        self.shiftadvcoef: float = -0.01
        self.shiftadvale: float = 0
        self.shiftadvncpress: float = 0
        ...
        #MDBC config
        self.mdbc_disth: float = 2.0
        self.mdbc_maxsizeh: float = 2.0 #? check
