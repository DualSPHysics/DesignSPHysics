...
class SetupPluginDialog(QtGui.QDialog):
    ...
    def __init__(self):
        ...
        def on_ok(self):
            ...
            executables_correct = Case.instance().executable_paths.check_and_filter()
        ...
        def on_gencase_browse(self):
            ...
            # noinspection PyArgumentList
            file_name, _ = filedialog.getOpenFileName(self,
                                                    "Select GenCase path",
                                                    QtCore.QDir.homePath())
            if file_name != "":
...
class InletZoneEdit(QtGui.QDialog):
    ...
    def __init__(self, inlet_object_id):
        ...
        self.zone2d3d_combobox.insertItems(0,
                                           [__("Left"), __("Right"), __("Front"), __("Back"), __("Top"), __("Bottom")])
