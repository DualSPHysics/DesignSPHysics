...
class ChronoConfigDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.csv_intervals_line_edit = QtWidgets.QLineEdit(str(self.case.chrono.csv_intervals.value))
        ...
        self.scale_scheme_line_edit = QtWidgets.QLineEdit(str(self.case.chrono.scale_scheme.value))
        ...
        self.collision_fields_distancedp_edit = QtWidgets.QLineEdit(str(self.case.chrono.collisiondp.distancedp))
