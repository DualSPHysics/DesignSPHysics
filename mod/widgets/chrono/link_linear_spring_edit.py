...
class LinkLinearspringEdit(QtWidgets.QDialog):
    ...
    def __init__(self, link_linearspring_id, bodies_widgets, parent=None):
        ...
        self.point_b1_x_line_edit = QtWidgets.QLineEdit(str(target_link_linearspring.point_fb1[0]))
        self.point_b1_y_label = QtWidgets.QLabel(__("Y"))
        self.point_b1_y_line_edit = QtWidgets.QLineEdit(str(target_link_linearspring.point_fb1[1]))
        self.point_b1_z_label = QtWidgets.QLabel(__("Z"))
        self.point_b1_z_line_edit = QtWidgets.QLineEdit(str(target_link_linearspring.point_fb1[2]))
        ...
        self.point_b2_x_line_edit = QtWidgets.QLineEdit(str(target_link_linearspring.point_fb2[0]))
        self.point_b2_y_label = QtWidgets.QLabel(__("Y"))
        self.point_b2_y_line_edit = QtWidgets.QLineEdit(str(target_link_linearspring.point_fb2[1]))
        self.point_b2_z_label = QtWidgets.QLabel(__("Z"))
        self.point_b2_z_line_edit = QtWidgets.QLineEdit(str(target_link_linearspring.point_fb2[2]))
        ...
        self.stiffness_line_edit = QtWidgets.QLineEdit(str(target_link_linearspring.stiffness))
        self.damping_label = QtWidgets.QLabel(__("Damping (Ns/m):"))
        self.damping_line_edit = QtWidgets.QLineEdit(str(target_link_linearspring.damping))
        ...
        self.rest_label = QtWidgets.QLabel(__("Rest length (m):"))
        self.rest_line_edit = QtWidgets.QLineEdit(str(target_link_linearspring.rest_length))
        ...
        self.vtk_nside_line_edit = QtWidgets.QLineEdit(str(target_link_linearspring.number_of_sections))
        self.vtk_radius_label = QtWidgets.QLabel(__("Spring radius: "))
        self.vtk_radius_line_edit = QtWidgets.QLineEdit(str(target_link_linearspring.spring_radius))
        self.vtk_length_label = QtWidgets.QLabel(__("Length for revolution: "))
        self.vtk_length_line_edit = QtWidgets.QLineEdit(str(target_link_linearspring.revolution_length))
