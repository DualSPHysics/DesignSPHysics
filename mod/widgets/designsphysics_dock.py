...
class DesignSPHysicsDock(QtWidgets.QDockWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("{} {} {}".format(APP_NAME, str(VERSION),str(VER_DATE)))
    ...
    def on_signal_update_dp(self):
        ...
        self.dp_widget.dp_input.setValue(Case.the().dp)
        self.dp_widget.on_dp_changed()
    ...
    def adapt_to_gencase_done(self, state: bool) -> None:
        ...
        #self.simulation_widget.execute_menu.setEnabled(state)

    def adapt_to_simulation_done(self, state: bool) -> None:
        """ Adapts the dock to an environment depending on if the simulation was run. """
