...
from mod.tools.template_tools import get_template_text, obj_to_dict
...
class CaseSummary(QtWidgets.QDialog):
    ...
    def get_objects_info(self) -> str:
        ...
        for obj in Case.the().objects:
            ...
            is_floating_text: str = "Yes" if Case.the().get_mk_based_properties(obj.real_mk()).float_property else "No"
            has_initials_text: str = "Yes" if Case.the().get_mk_based_properties(obj.real_mk()).initials else "No"
