...
from mod.widgets.dock.special_widgets.chrono.chrono_object_check_options import ChronoObjectCheckOptions
from mod.widgets.dock.special_widgets.chrono.link_coulombdamping_edit import LinkCoulombDampingEdit
from mod.widgets.dock.special_widgets.chrono.link_hinge_edit import LinkHingeEdit
from mod.widgets.dock.special_widgets.chrono.link_linear_spring_edit import LinkLinearspringEdit
from mod.widgets.dock.special_widgets.chrono.link_point_line_edit import LinkPointlineEdit
from mod.widgets.dock.special_widgets.chrono.link_pulley_edit import LinkPulleyEdit
from mod.widgets.dock.special_widgets.chrono.link_spheric_edit import LinkSphericEdit
from mod.widgets.custom_widgets.value_input import ValueInput


class ChronoConfigDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.csv_option_layout = QtWidgets.QHBoxLayout()
        self.csv_intervals_checkbox = QtWidgets.QCheckBox()
        ...
        self.csv_intervals_option = QtWidgets.QLabel(__("CSV intervals:"))
        self.csv_intervals_line_edit = ValueInput(min_val=0)
        self.csv_intervals_line_edit.setValue(self.case.chrono.csv_intervals.value)
        ...
        self.scale_scheme_option_layout = QtWidgets.QHBoxLayout()
        self.scale_scheme_checkbox = QtWidgets.QCheckBox()
        ...
        self.scale_scheme_option = QtWidgets.QLabel(__("Scale for scheme:"))
        self.scale_scheme_line_edit = ValueInput(min_val=0)
        self.scale_scheme_line_edit.setValue(self.case.chrono.scale_scheme.value)
        ...
        self.collisiondp_option_layout = QtWidgets.QHBoxLayout()
        self.collisiondp_checkbox = QtWidgets.QCheckBox()
        ...
        self.collisiondp_option = QtWidgets.QLabel(__("Enable/Disable Collision"))
        ...
        self.collision_fields_widget = QtWidgets.QWidget();
        self.collision_fields_widget_layout = QtWidgets.QVBoxLayout()
        
        self.collision_fields_distancedp_layout = QtWidgets.QHBoxLayout()
        self.collision_fields_distancedp_label = QtWidgets.QLabel("Allowed collision overlap:")
        self.collision_fields_distancedp_edit = ValueInput(min_val=0)
        self.collision_fields_distancedp_edit.setValue(self.case.chrono.collisiondp.distancedp)
        ...
        self.collision_fields_ompthreads_layout = QtWidgets.QHBoxLayout()
        self.collision_fields_ompthreads_label = QtWidgets.QLabel("Parallel execution type:")
        self.collision_fields_ompthreads_combo = QtWidgets.QComboBox()
        ...
        self.collision_fields_contactmethod_layout = QtWidgets.QHBoxLayout()
        self.collision_fields_contactmethod_label = QtWidgets.QLabel("Contact method type:")
        self.collision_fields_contactmethod_combo = QtWidgets.QComboBox()
        ...
        self.main_chrono = QtWidgets.QGroupBox("Chrono objects")
        self.main_chrono.setMinimumHeight(150)
        self.chrono_layout = QtWidgets.QVBoxLayout()
        ...
        for sim_object in self.case.get_all_bound_objects():
            ...
            self.is_floating = "bodyfloating" if self.case.get_mk_based_properties(sim_object.real_mk()).float_property else "bodyfixed"
        ...
        self.main_link_linearspring = QtWidgets.QGroupBox("Linearspring")
        self.link_linearspring_layout = QtWidgets.QVBoxLayout()
        self.link_linearspring_layout2 = QtWidgets.QVBoxLayout()

        self.link_linearspring_button_layout = QtWidgets.QHBoxLayout()
        self.button_link_linearspring = QtWidgets.QPushButton("Add")
        ...
        self.main_link_hinge = QtWidgets.QGroupBox("Hinge")
        self.link_hinge_layout = QtWidgets.QVBoxLayout()
        self.link_hinge_layout2 = QtWidgets.QVBoxLayout()

        self.link_hinge_button_layout = QtWidgets.QHBoxLayout()
        self.button_link_hinge = QtWidgets.QPushButton("Add")
        ...
        self.main_link_spheric = QtWidgets.QGroupBox("Spheric")
        self.link_spheric_layout = QtWidgets.QVBoxLayout()
        self.link_spheric_layout2 = QtWidgets.QVBoxLayout()

        self.link_spheric_button_layout = QtWidgets.QHBoxLayout()
        self.button_link_spheric = QtWidgets.QPushButton("Add")
        ...
        self.main_link_pointline = QtWidgets.QGroupBox("Pointline")
        self.link_pointline_layout = QtWidgets.QVBoxLayout()
        self.link_pointline_layout2 = QtWidgets.QVBoxLayout()

        self.link_pointline_button_layout = QtWidgets.QHBoxLayout()
        self.button_link_pointline = QtWidgets.QPushButton("Add")
        ...
        self.main_link_coulombdamping = QtWidgets.QGroupBox("Coulombdamping")
        self.link_coulombdamping_layout = QtWidgets.QVBoxLayout()
        self.link_coulombdamping_layout2 = QtWidgets.QVBoxLayout()

        self.link_coulombdamping_button_layout = QtWidgets.QHBoxLayout()
        self.button_link_coulombdamping = QtWidgets.QPushButton("Add")
        ...
        self.main_link_pulley = QtWidgets.QGroupBox("Pulley")
        self.link_pulley_layout = QtWidgets.QVBoxLayout()
        self.link_pulley_layout2 = QtWidgets.QVBoxLayout()

        self.link_pulley_button_layout = QtWidgets.QHBoxLayout()
        self.button_link_pulley = QtWidgets.QPushButton("Add")
        ...
        # Adds scroll area
        self.main_layout_dialog = QtWidgets.QVBoxLayout()
        self.main_layout_scroll = QtWidgets.QScrollArea()
        self.main_layout_scroll.setMinimumWidth(400)
        self.main_layout_scroll.setWidgetResizable(True)
        self.main_layout_scroll_widget = QtWidgets.QWidget()
    ...
    def refresh_link_hinge(self):
        ...
        for linkhinge in self.case.chrono.link_hinge:
            ...
            to_add_label = QtWidgets.QLabel("Link hinge" + str(count))
    ...
    def refresh_link_linearspring(self):
        ...
        for linkLinearspring in self.case.chrono.link_linearspring:
            count += 1
            to_add_layout = QtWidgets.QHBoxLayout()
            to_add_label = QtWidgets.QLabel("Link linearspring" + str(count))
            to_add_layout.addWidget(to_add_label)
            to_add_layout.addStretch(1)
            to_add_editbutton = QtWidgets.QPushButton("Edit")
            to_add_deletebutton = QtWidgets.QPushButton("Delete")
    ...
    def refresh_link_spheric(self):
        ...
        for linkSpheric in self.case.chrono.link_spheric:
            count += 1
            to_add_layout = QtWidgets.QHBoxLayout()
            to_add_label = QtWidgets.QLabel("Link spheric" + str(count))
            to_add_layout.addWidget(to_add_label)
            to_add_layout.addStretch(1)
            to_add_editbutton = QtWidgets.QPushButton("Edit")
            to_add_deletebutton = QtWidgets.QPushButton("Delete")
    ...
    def refresh_link_pointline(self):
        ...
        for linkPointline in self.case.chrono.link_pointline:
            count += 1
            to_add_layout = QtWidgets.QHBoxLayout()
            to_add_label = QtWidgets.QLabel("Link pointline" + str(count))
            to_add_layout.addWidget(to_add_label)
            to_add_layout.addStretch(1)
            to_add_editbutton = QtWidgets.QPushButton("Edit")
            to_add_deletebutton = QtWidgets.QPushButton("Delete")
    ...
    def refresh_link_coulombdamping(self):
        ...
        for linkCoulombdamping in self.case.chrono.link_coulombdamping:
            count += 1
            to_add_layout = QtWidgets.QHBoxLayout()
            to_add_label = QtWidgets.QLabel("Link coulombdamping" + str(count))
            to_add_layout.addWidget(to_add_label)
            to_add_layout.addStretch(1)
            to_add_editbutton = QtWidgets.QPushButton("Edit")
            to_add_deletebutton = QtWidgets.QPushButton("Delete")
    ...
    def refresh_link_pulley(self):
        ...
        for linkPulley in self.case.chrono.link_pulley:
            count += 1
            to_add_layout = QtWidgets.QHBoxLayout()
            to_add_label = QtWidgets.QLabel("Link pulley" + str(count))
            to_add_layout.addWidget(to_add_label)
            to_add_layout.addStretch(1)
            to_add_editbutton = QtWidgets.QPushButton("Edit")
            to_add_deletebutton = QtWidgets.QPushButton("Delete")
    ...
    def link_hinge_edit(self, link_hinge_id):
        ...
        LinkHingeEdit(link_hinge_id=link_hinge_id, bodies_widgets=selected_chrono_object_widgets, parent=None)
        self.refresh_link_hinge()
    ...
    def link_linearspring_edit(self, link_linearspring_id):
        ...
        selected_chrono_object_widgets = list(filter(lambda x: x.object_check.isChecked(), self.chrono_object_options_widgets))
        LinkLinearspringEdit(link_linearspring_id=link_linearspring_id, bodies_widgets=selected_chrono_object_widgets, parent=None)
        self.refresh_link_linearspring()
    ...
    def link_spheric_edit(self, link_spheric_id):
        ...
        selected_chrono_object_widgets = list(filter(lambda x: x.object_check.isChecked(), self.chrono_object_options_widgets))
        LinkSphericEdit(link_spheric_id=link_spheric_id, bodies_widgets=selected_chrono_object_widgets, parent=None)
        self.refresh_link_spheric()
    ...
    def link_pointline_edit(self, link_pointline_id):
        ...
        selected_chrono_object_widgets = list(filter(lambda x: x.object_check.isChecked(), self.chrono_object_options_widgets))
        LinkPointlineEdit(link_pointline_id=link_pointline_id, bodies_widgets=selected_chrono_object_widgets, parent=None)
        self.refresh_link_pointline()
    ...
    def link_coulombdamping_edit(self, link_coulombdamping_id):
        ...
        selected_chrono_object_widgets = list(filter(lambda x: x.object_check.isChecked(), self.chrono_object_options_widgets))
        LinkCoulombDampingEdit(link_coulombdamping_id=link_coulombdamping_id, bodies_widgets=selected_chrono_object_widgets, parent=None)
        self.refresh_link_coulombdamping()
    ...
    def link_pulley_edit(self, link_pulley_id):
        ...
        selected_chrono_object_widgets = list(filter(lambda x: x.object_check.isChecked(), self.chrono_object_options_widgets))
        LinkPulleyEdit(link_pulley_id=link_pulley_id, bodies_widgets=selected_chrono_object_widgets, parent=None)
        self.refresh_link_pulley()
    ...
    def update_to_save(self):
        ...
        if self.csv_intervals_checkbox.isChecked():
            ...
            try:
                self.case.chrono.csv_intervals.value = self.csv_intervals_line_edit.value()
            except ValueError:
        ...
        if self.scale_scheme_checkbox.isChecked():
            ...
            try:
                self.case.chrono.scale_scheme.value = self.scale_scheme_line_edit.value()
            except ValueError:
        ...
        if self.collisiondp_checkbox.isChecked():
            ...
            try:
                self.case.chrono.collisiondp.distancedp = self.collision_fields_distancedp_edit.value()
                ...
                warning_dialog("Introduced an invalid value in collision widgets.")
        else:
            self.case.chrono.collisiondp.enabled = False
