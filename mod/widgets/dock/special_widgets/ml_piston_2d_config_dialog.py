...
from mod.dataobjects.properties.ml_piston.ml_piston_2d_veldata import MLPiston2DVeldata
...
class MLPiston2DConfigDialog(QtWidgets.QDialog):
    ...
    def __init__(self, mk=None, mlpiston2d=None, parent=None):
        ...
        self.smooth_z = IntValueInput(min_val=0)
        self.smooth_y = IntValueInput(min_val=0)
    ...
    def on_apply(self):
        ...
        self.temp_mlpiston2d.incz = self.incz_input.value()
        self.temp_mlpiston2d.smoothz = self.smooth_z.value()
        self.temp_mlpiston2d.smoothy = self.smooth_y.value()
    ...
    def fill_data(self):
        ...
        self.incz_input.setValue(self.temp_mlpiston2d.incz)
        self.smooth_z.setValue(self.temp_mlpiston2d.smoothz)
        self.smooth_y.setValue(self.temp_mlpiston2d.smoothy)
    ...
    def on_browse(self):
        ...
        self.veldata_filevelx_input.setValue(filename_filtered)
