...
class MoorDynPlusBodyConfigurationDialog(QtWidgets.QDialog):
    """ DesignSPHysics MoorDynPlus Body Configuration Dialog. """

    def __init__(self, body):
        super().__init__()
        self.body: MoorDynPlusBody = body

        self.setWindowTitle(__("MoorDynPlus Body Configuration"))
    ...
    def _on_ok(self):
        self.body.depth = self.depth_value_line_edit.value() if self.depth_enable_check.isChecked() and self.depth_value_line_edit.text() else False
        self.accept()
