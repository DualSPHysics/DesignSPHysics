...
class ErrorReportDialog(QtWidgets.QDialog):
    ...
    def __init__(self, exception_type, value, traceback_str):
        ...
        self.message_label = QtWidgets.QLabel("DesignSPHysics encountered an error. Please report the developer the following details.")
        self.button_layout = QtWidgets.QHBoxLayout()
        self.details_widget = QtWidgets.QWidget()

        self.report_button = QtWidgets.QPushButton("Report error")
        ...
        self.traceback_textarea = QtWidgets.QTextEdit("<b>DesignSPHysics version</b>: {}<br/>".format(VERSION) +
