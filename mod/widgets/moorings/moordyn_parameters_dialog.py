...
class MoorDynParametersDialog(QtGui.QDialog):
    ...
    def __init__(self, moordyn_parameters_data: MoorDynConfiguration):
        ...
        self.kBot_label: QtGui.QLabel = QtGui.QLabel(__("<b>[kBot]</b> Bottom stiffness constant (Pa/m):"))
        self.kBot_label.setToolTip(__("Bottom stiffness constant. (default=3.0e6)"))
        self.cBot_label: QtGui.QLabel = QtGui.QLabel(__("<b>[cBot]</b> Bottom damping constant (Pa*s/m):"))
        self.cBot_label.setToolTip(__("Bottom damping constant. (default=3.0e5)"))
        self.fricdamp_label: QtGui.QLabel = QtGui.QLabel(__("<b>[fricDamp]</b> Damping coefficient:"))
        self.fricdamp_label.setToolTip(__("Damping coefficient used to model the friction at speeds near zero. (default=200.0)"))
        self.statdynfricscale_label: QtGui.QLabel = QtGui.QLabel(__("<b>[statDynFricScale]</b> Ratio of static/dynamic friction:"))
        self.statdynfricscale_label.setToolTip(__("Ratio of static to dynamic friction (mu_static/mu_dynamic). (default=1.0)"))
        self.dtIC_label: QtGui.QLabel = QtGui.QLabel(__("<b>[dtIC]</b> Convergence analysis time step (s):"))
        self.dtIC_label.setToolTip(__("Period for analyzing convergence of dynamic relaxation IC generation. (default=1.0)"))
        self.cdScaleIC_label: QtGui.QLabel = QtGui.QLabel(__("<b>[cdScaleIC]</b> ICDfac:"))
        self.cdScaleIC_label.setToolTip(__("Factor by which to scale drag coefficients during dynamic relaxation IC generation. (default=5)"))
        self.tmaxIC_label: QtGui.QLabel = QtGui.QLabel(__("<b>[tmaxIC]</b> Max time for IC (s):"))
        self.tmaxIC_label.setToolTip(__("Maximum simulation time to allow for IC generation without convergence.(default=10)"))
        self.timeMax_label: QtGui.QLabel = QtGui.QLabel(__("<b>[timeMax]</b> Simulation Time (s):"))
        ...
        self.ea_label.setToolTip(__("The line stiffness, product of elasticity modulus and cross-sectional area."))
        self.diameter_label: QtGui.QLabel = QtGui.QLabel(__("<b>[diameter]</b> Diameter (m):"))
        self.diameter_label.setToolTip(__("The volume-equivalent diameter of the line."))
        self.massDenInAir_label: QtGui.QLabel = QtGui.QLabel(__("<b>[massDenInAir]</b> Mass per unit length (kg/m):"))
        self.massDenInAir_label.setToolTip(__("The mass per unit length of the line."))
        self.ba_label: QtGui.QLabel = QtGui.QLabel(__("<b>[ba]</b> Line internal damping (Ns):"))
        self.ba_label.setToolTip(__("The line internal damping (BA/-zeta). (default=-0.8)"))
        self.can_label: QtGui.QLabel = QtGui.QLabel(__("<b>[can]</b> Transverse added mass coefficient:"))
        self.can_label.setToolTip(__("Transverse added mass coefficient (with respect to line displacement). (default=1.0)"))
        self.cat_label: QtGui.QLabel = QtGui.QLabel(__("<b>[cat]</b> Tangential added mass coefficient:"))
        self.cat_label.setToolTip(__("Tangential added mass coefficient (with respect to line displacement). (default=0.0)"))
        self.cdn_label: QtGui.QLabel = QtGui.QLabel(__("<b>[cdn]</b> Transverse drag coefficient:"))
        self.cdn_label.setToolTip(__("Transverse drag coefficient (with respect to frontal area, d*l). (default=1.6)"))
        self.cdt_label: QtGui.QLabel = QtGui.QLabel(__("<b>[cdt]</b> Tangential drag coefficient:"))
