...
class MoorDynParametersDialog(QtGui.QDialog):
    ...
    def __init__(self, moordyn_parameters_data: MoorDynConfiguration):
        ...
        self.statdynfricscale_label: QtGui.QLabel = QtGui.QLabel(__("Ratio of static/dynamic friction:"))
        ...
        self.tmaxIC_label: QtGui.QLabel = QtGui.QLabel(__("Max time for initial conditions generation (s):"))
        ...
        self.ea_label: QtGui.QLabel = QtGui.QLabel(__("Stiffness (N):"))
