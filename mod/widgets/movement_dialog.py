...
from mod.widgets.movement_timeline_placeholder import MovementTimelinePlaceholder
from mod.widgets.rectilinear_motion_timeline import RectilinearMotionTimeline
from mod.widgets.wait_motion_timeline import WaitMotionTimeline
from mod.widgets.acc_rectilinear_motion_timeline import AccRectilinearMotionTimeline
from mod.widgets.rotational_motion_timeline import RotationalMotionTimeline
from mod.widgets.acc_rotational_motion_timeline import AccRotationalMotionTimeline
from mod.widgets.acc_circular_motion_timeline import AccCircularMotionTimeline
from mod.widgets.rot_sinu_motion_timeline import RotSinuMotionTimeline
from mod.widgets.cir_sinu_motion_timeline import CirSinuMotionTimeline
from mod.widgets.rect_sinu_motion_timeline import RectSinuMotionTimeline
from mod.widgets.regular_piston_wave_motion_timeline import RegularPistonWaveMotionTimeline
from mod.widgets.irregular_piston_wave_motion_timeline import IrregularPistonWaveMotionTimeline
from mod.widgets.regular_flap_wave_motion_timeline import RegularFlapWaveMotionTimeline
from mod.widgets.irregular_flap_wave_motion_timeline import IrregularFlapWaveMotionTimeline
from mod.widgets.file_motion_timeline import FileMotionTimeline
from mod.widgets.rotation_file_motion_timeline import RotationFileMotionTimeline
from mod.widgets.movement_actions import MovementActions
from mod.widgets.wave_movement_actions import WaveMovementActions


# FIXME: Change data references to refactored Case structure
class MovementDialog(QtGui.QDialog):
    ...
    def refresh_movements_table(self):
        ...
        #create_new_movement_menu.addAction(get_icon("movement.png"), __("Movement"))
        #create_new_movement_menu.addAction(get_icon("regular_wave.png"), __("Regular wave generator (Piston)"))
        #create_new_movement_menu.addAction(get_icon("irregular_wave.png"), __("Irregular wave generator (Piston)"))
        #create_new_movement_menu.addAction(get_icon("regular_wave.png"), __("Regular wave generator (Flap)"))
        #create_new_movement_menu.addAction(get_icon("irregular_wave.png"), __("Irregular wave generator (Flap)"))
        #create_new_movement_menu.addAction(get_icon("file_mov.png"), __("Linear motion from a file"))
        #create_new_movement_menu.addAction(get_icon("file_mov.png"), __("Rotation from a file"))
