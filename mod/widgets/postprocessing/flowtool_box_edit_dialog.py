...
class FlowToolBoxEditDialog(QtWidgets.QDialog):
    """ DesignSPHysics FlowTool Box Edit Dialog. """
    ...
    def __init__(self, box_id, parent=None):
        ...
        self.box_edit_layout = QtWidgets.QVBoxLayout()
        ...
        self.box_edit_name_input = QtWidgets.QLineEdit(target_box.name)
        self.box_edit_name_layout.addWidget(self.box_edit_name_label)
        self.box_edit_name_layout.addWidget(self.box_edit_name_input)

        self.box_edit_description = QtWidgets.QLabel(__("Using multiple boxes with the same name will produce only one volume to measure.\n"
        ...
        # Reference image
        self.box_edit_image = QtWidgets.QLabel()
        ...
        # Point coords inputs
        self.box_edit_points_layout = QtWidgets.QVBoxLayout()

        self.box_edit_point_a_layout = QtWidgets.QHBoxLayout()
        self.box_edit_point_a_label = QtWidgets.QLabel(__("Point A (X, Y, Z)"))
        self.box_edit_point_a_x = QtWidgets.QLineEdit(str(target_box.point1[0]))
        self.box_edit_point_a_y = QtWidgets.QLineEdit(str(target_box.point1[1]))
        self.box_edit_point_a_z = QtWidgets.QLineEdit(str(target_box.point1[2]))
        ...
        self.box_edit_point_b_layout = QtWidgets.QHBoxLayout()
        self.box_edit_point_b_label = QtWidgets.QLabel(__("Point B (X, Y, Z)"))
        self.box_edit_point_b_x = QtWidgets.QLineEdit(str(target_box.point2[0]))
        self.box_edit_point_b_y = QtWidgets.QLineEdit(str(target_box.point2[1]))
        self.box_edit_point_b_z = QtWidgets.QLineEdit(str(target_box.point2[2]))
        ...
        self.box_edit_point_c_layout = QtWidgets.QHBoxLayout()
        self.box_edit_point_c_label = QtWidgets.QLabel(__("Point C (X, Y, Z)"))
        self.box_edit_point_c_x = QtWidgets.QLineEdit(str(target_box.point3[0]))
        self.box_edit_point_c_y = QtWidgets.QLineEdit(str(target_box.point3[1]))
        self.box_edit_point_c_z = QtWidgets.QLineEdit(str(target_box.point3[2]))
        ...
        self.box_edit_point_d_layout = QtWidgets.QHBoxLayout()
        self.box_edit_point_d_label = QtWidgets.QLabel(__("Point D (X, Y, Z)"))
        self.box_edit_point_d_x = QtWidgets.QLineEdit(str(target_box.point4[0]))
        self.box_edit_point_d_y = QtWidgets.QLineEdit(str(target_box.point4[1]))
        self.box_edit_point_d_z = QtWidgets.QLineEdit(str(target_box.point4[2]))
        ...
        self.box_edit_point_e_layout = QtWidgets.QHBoxLayout()
        self.box_edit_point_e_label = QtWidgets.QLabel(__("Point E (X, Y, Z)"))
        self.box_edit_point_e_x = QtWidgets.QLineEdit(str(target_box.point5[0]))
        self.box_edit_point_e_y = QtWidgets.QLineEdit(str(target_box.point5[1]))
        self.box_edit_point_e_z = QtWidgets.QLineEdit(str(target_box.point5[2]))
        ...
        self.box_edit_point_f_layout = QtWidgets.QHBoxLayout()
        self.box_edit_point_f_label = QtWidgets.QLabel(__("Point F (X, Y, Z)"))
        self.box_edit_point_f_x = QtWidgets.QLineEdit(str(target_box.point6[0]))
        self.box_edit_point_f_y = QtWidgets.QLineEdit(str(target_box.point6[1]))
        self.box_edit_point_f_z = QtWidgets.QLineEdit(str(target_box.point6[2]))
        ...
        self.box_edit_point_g_layout = QtWidgets.QHBoxLayout()
        self.box_edit_point_g_label = QtWidgets.QLabel(__("Point G (X, Y, Z)"))
        self.box_edit_point_g_x = QtWidgets.QLineEdit(str(target_box.point7[0]))
        self.box_edit_point_g_y = QtWidgets.QLineEdit(str(target_box.point7[1]))
        self.box_edit_point_g_z = QtWidgets.QLineEdit(str(target_box.point7[2]))
        ...
        self.box_edit_point_h_layout = QtWidgets.QHBoxLayout()
        self.box_edit_point_h_label = QtWidgets.QLabel(__("Point H (X, Y, Z)"))
        self.box_edit_point_h_x = QtWidgets.QLineEdit(str(target_box.point8[0]))
        self.box_edit_point_h_y = QtWidgets.QLineEdit(str(target_box.point8[1]))
        self.box_edit_point_h_z = QtWidgets.QLineEdit(str(target_box.point8[2]))
        ...
        self.box_edit_button_layout = QtWidgets.QHBoxLayout()
        self.box_edit_button_ok = QtWidgets.QPushButton(__("OK"))
        self.box_edit_button_cancel = QtWidgets.QPushButton(__("Cancel"))
