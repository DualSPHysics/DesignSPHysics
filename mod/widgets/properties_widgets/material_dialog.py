...
class MaterialDialog(QtWidgets.QDialog):
    ...
    def __init__(self, selection_name, parent=None):
        ...
        self.target_mkbasedproperties: MKBasedProperties = Case.the().get_mk_based_properties(self.target_object.real_mk())
    ...
    def on_ok(self):
        ...
        info_dialog(__("This will apply the material properties to all objects with mkbound = ") + str(self.target_object.obj_mk))
