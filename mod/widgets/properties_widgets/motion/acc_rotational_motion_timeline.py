...
class AccRotationalMotionTimeline(MotionTimeline):
    ...
    def fill_values(self, acc_rot_motion):
        ...
        self.x1_input.setValue(acc_rot_motion.axis1[0])
        self.y1_input.setValue(acc_rot_motion.axis1[1])
        self.z1_input.setValue(acc_rot_motion.axis1[2])
        self.x2_input.setValue(acc_rot_motion.axis2[0])
        self.y2_input.setValue(acc_rot_motion.axis2[1])
        self.z2_input.setValue(acc_rot_motion.axis2[2])
        self.velocity_input.setValue(acc_rot_motion.ang_vel)
        self.acceleration_input.setValue(acc_rot_motion.ang_acc)
        self.time_input.setValue(acc_rot_motion.duration)
