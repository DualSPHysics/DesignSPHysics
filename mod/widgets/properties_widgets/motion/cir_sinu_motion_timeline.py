...
class CirSinuMotionTimeline(MotionTimeline):
    ...
    def __init__(self, index, cir_sinu_motion, parent=None):
        ...
        self.axis1_label = QtWidgets.QLabel("Axis 1(X,Y,Z):")
        self.axis2_label = QtWidgets.QLabel("Axis 2(X,Y,Z):")
        ...
        self.fourth_row_layout.addWidget(self.reference_label)
        self.fourth_row_layout.addWidget(self.reference_x_input)
        self.fourth_row_layout.addWidget(self.reference_y_input)
        self.fourth_row_layout.addWidget(self.reference_z_input)
        ...
        self.rows_layout.addLayout(self.fourth_row_layout)
    ...
    def fill_values(self, cir_sinu_motion):
        ...
        self.x1_input.setValue(cir_sinu_motion.axis1[0])
        self.y1_input.setValue(cir_sinu_motion.axis1[1])
        self.z1_input.setValue(cir_sinu_motion.axis1[2])
        self.x2_input.setValue(cir_sinu_motion.axis2[0])
        self.y2_input.setValue(cir_sinu_motion.axis2[1])
        self.z2_input.setValue(cir_sinu_motion.axis2[2])
        self.reference_x_input.setValue(cir_sinu_motion.reference[0])
        self.reference_y_input.setValue(cir_sinu_motion.reference[1])
        self.reference_z_input.setValue(cir_sinu_motion.reference[2])
        self.freq_input.setValue(cir_sinu_motion.freq)
        self.ampl_input.setValue(cir_sinu_motion.ampl)
        self.phase_input.setValue(cir_sinu_motion.phase)
        self.time_input.setValue(cir_sinu_motion.duration)
    ...
    def construct_motion_object(self):
        ...
        sinu_motion = CirSinuMotion(
            ...
            ampl=self.ampl_input.value(), phase=self.phase_input.value())
        return sinu_motion
